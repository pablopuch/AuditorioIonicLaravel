...
use App\Models\ControlVersions;

class ControlVersionsController extends Controller
{
     ...
     {
         $controlVersion = ControlVersions::all();
     ...
     public function destroy(Request $request)
     {
         ...
         $controlVersion = ControlVersions::destroy($request->id);
